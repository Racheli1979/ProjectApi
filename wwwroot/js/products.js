...
function addItem() {
    ...
    const item = {
        ...
        quetionTime: parseFloat(addQuetionTimeTextbox.value),
    };
...
function updateItem() {
    ...
    const item = {
        ...
        quetionTime: parseFloat(document.getElementById('edit-quetionTime').value)
    };
...
function _displayCount(itemCount) {
    const name = (itemCount === 1) ? 'Accessory item' : 'Accessories items';
}

// פונקציה להצגת המוצרים בטבלה
function _displayItems(data) {
    const tBody = document.getElementById('newbornItems');
    tBody.innerHTML = '';
